...
YOUR_MAIL_ID = "b22cs035@iitj.ac.in"
PASWORD = "bktt jgno nymo zfnk"
...
class MainThread(QThread):
    ...
    def qrCodeGenerator(self):
        ...
        img.save(fr"QRCodes\{QRfile_name}")
    ...
    def Mobilecamra(self):
        ...
        try:
            ...
            URL = "http://172.31.84.239:8080/shot.jpg" #Discription for this is available in the README file
            while True:
